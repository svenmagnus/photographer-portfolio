...
const $$postSlug = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BlogPostPage", $$BlogPostPage, { "locale": "en", "blogSlug": blogSlug, "postSlug": postSlug })}`;
}, "/Users/svenmagnus/Websites/Portfolio_Sven_Magnus/web/src/pages/en/[slug]/[postSlug].astro", void 0);

const $$file = "/Users/svenmagnus/Websites/Portfolio_Sven_Magnus/web/src/pages/en/[slug]/[postSlug].astro";
const $$url = "/en/[slug]/[postSlug]";
